...
namespace Object_Classes {
    ...
    public class Player {
        ...
        public void Play(Die d1, Die d2) {
                ...
                //  The total of the two die is the amount we want to move our player. 
                int DieTotal = d1.Roll() + d2.Roll();
                //update the position by adding current position to sum of two dies. 
                Position = DieTotal + Position;

                //Prevent the player from going beyond the final square. 
                //If the player is beyond, the position is set to the final square. 
                ...
                //set the boolean atFinish to true if player reaches finish. 
                if (ReachedFinalSquare()) { atFinish = true; }
        ...
        private bool ReachedFinalSquare() {
            ...
            if (position >= Board.FINISH_SQUARE_NUMBER) { return true; };
